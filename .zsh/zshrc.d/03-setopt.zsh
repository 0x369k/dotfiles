...
# DEBUG
#setopt NO_UNSET                 # verhindert, dass Skripte fortfahren, wenn eine Variable nicht gesetzt ist
#setopt ERR_EXIT                 # bewirkt, dass Zsh bei einem Fehler in einem Skript oder einer Pipeline beendet wird
