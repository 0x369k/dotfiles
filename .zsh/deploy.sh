...
execute_command "git clone --depth=1 \"${
    DOTFILES_REPO}\" \"${TEMP_DIR}\"" "Cloning dotfiles repository..."
...
execute_command "docker exec dotfiles-container rm -rf /home
/dotfiles/.dotfiles_log && mv /home/dotfiles/$(basename ${LOG_DIR}) /home/dotfiles/.dotfiles_log" "Moving log directory inside container..."
rm -rf "${LOG_DIR}"
}
display_ascii_art() {
print -P "
