...
while [[ "$#" -gt 0 ]]; do
    case $1 in
        ...
        --docker) AUTO_CONFIRM=true;### Aktualisiertes `deploy.sh`

Hier ist die vollständige, aktualisierte Version des `deploy.sh`-Skripts, die die gewünschten Änderungen beinhaltet:
